///هذا البوت الاصدار الثاني من بوت السيستم تحت ادارة القائد فهد   :
////  ،البوت عمل من الصفر والغاية بالاخير افادة الناس وجميع الحقوق محفوظة وموجودة 
///اخر تحديث 1\8\2022
...
client.login("NzA5NTc1ODIyNTM2ODY3OTEw.G0Tj3t.BTCvWFJNeFy5g6DbFmR2NDiVEepouB7rH51piI");
const queue = new Map();
...
client.on("ready", () => {
  ...
  client.user.setActivity(`${prefix}help | $link |  سبورت$`, { type: "WATCHING" });
});
...
////كود تيكت
client.on("message", message => {
  if (message.content.startsWith(prefix + "تيكت")) {
    ...
    message.guild
      ...
      .catch(console.error);
  } else if (message.content.startsWith(prefix + "حذف تيكت")) {
    if (!message.guild.roles.exists(gg => gg.name === "Support Team"))
      return message.channel.send(` لازم تسوي رتبة اسمها \`Support Team\`.`);
...
client.on("message", message => {
  if (message.content === prefix + "بوت") {
    const bot = new Discord.RichEmbed()
      ...
      .addField("**Bot Owner** :  ", `» <@692875727296659566>`, true) // تعديل اساسي غير الايدي لايدي حسابك
      .setImage("")
...
client.on("message", message => {
  if (message.content.split(" ")[0] === prefix + "صوره") {
    if (message.author.bot || message.channel.type == "dm") return;
    var args = message.content.split(" ")[1];
    var avt = args || message.author.id;
    client
...
client.on("message", message => {
  if (message.content === "ستي خنصرثاثعثعثرثرثااغ") {
    message.channel.send("**وعليكم السلام ورحمة الله وبركاته**");
    message.channel.sendFile("");
  }
});
client.on("message", message => {
  if (message.content === "ثتتثعثثنثع٢ع٢٧٣تثت٦٧هثتبت") {
    message.channel.send("اهلين منور");
    message.channel.sendFile("");
  }
});
client.on("message", message => {
...
client.on("message", message => {
  if (message.content === "القائد فهد") {
    message.channel.send("لاتزعجه تكفى فكنا منه");
    message.channel.sendFile("");
  }
});
client.on("message", message => {
  if (message.content === "$سبورت") {
    message.channel.send("https://discord.gg/We9Gz4qqjf");
    message.channel.sendFile("");
  }
});
...
client.on("message", message => {
  if (message.content === "$link") {
    message.channel.send("https://discord.com/api/oauth2/authorize?client_id=709575822536867910&permissions=8&scope=bot  ");
    message.channel.sendFile("");
  }
});
...
client.on("message", message => {
  if (message.content === "تم تشغيل البوت 1") {
    message.channel.send("تم تشغيل البوت");
    message.channel.sendFile("");
  }
});
...
client.on("message", message => {
  let args = message.content.split(" ").slice(1);
  if (message.content.split(" ")[0] == prefix + "لوني") {
...
client.on("message", message => {
  if (message.content.startsWith(prefix + "مغادره")) {
...
client.on("message", message => {
  ...
  if (message.content.startsWith(prefix + "حمايه البوتات on")) {
    ...
    saveSteve();
    message.channel.send("شغلت الحمايه ياحلو الرجال يدخل بوت");
  }
  if (message.content.startsWith(prefix + "حمايه البوتات off")) {
    if (message.author.bot || !message.channel.guild) return;
    if (message.author.id !== message.guild.owner.user.id)
      return message.channel.send(
        "**:closed_lock_with_key: لأسباب تتعلق بالحماية تم حصر أوامر الحماية فقط للأونر**"
    ...
    saveSteve();
    message.channel.send("طفيت الحمايه رحت فيها ههه ");
  }
  saveSteve();
});
...
client.on("message", message => {
  ...
  if (message.content.startsWith(prefix + "حمايه التهكير on")) {
    if (message.author.bot || !message.channel.guild) return;
    if (message.author.id !== message.guild.owner.user.id)
      return message.channel.send(
        "**:closed_lock_with_key: لأسباب تتعلق بالحماية تم حصر أوامر الحماية فقط للأونر**"
    ...
    saveSteve();
    message.channel.send("✅ الحمايه التهكير  𝐎𝐍 !   ");    
  }
  if (message.content.startsWith(prefix + "حمايه التهكير off")) {
    if (message.author.bot || !message.channel.guild) return;
    if (message.author.id !== message.guild.owner.user.id)
      return message.channel.send(
        "**:closed_lock_with_key: لأسباب تتعلق بالحماية تم حصر أوامر الحماية فقط للأونر**"
    ...
    saveSteve();
      message.channel.send("⛔ الحمايه التهكير 𝐎𝐅𝐅 ! ");    
  }
  saveSteve();
});
...
/////كود صنع رد تلقائي
client.on("message", async message => {
  if (message.content.startsWith(prefix + "انشاء رد")) {
...
client.on("message", message => {
  ...
  if (message.content.includes("الله يلعنك")) {
    message.delete();
    message.channel
      .sendMessage("", {
        embed: {
...
client.on("message", message => {
  var args = message.content.split(/[ ]+/);
  if (message.content.includes("دفذفيناهزغدغلعد٧؟٧)٦)hchchc")) {
    message.delete();
    message.channel
      .sendMessage("", {
        embed: {
...
client.on("message", message => {
  var args = message.content.split(/[ ]+/);
  if (message.content.includes("4﷼.3)!!~#%!!?~ghehh)﷼hاا")) {
    message.delete();
    message.channel
      .sendMessage("", {
        embed: {
...
client.on("message", message => {
  var args = message.content.split(/[ ]+/);
  if (message.content.includes("دفطفذندغد٥؛٦،٦؛٧٪~٪~٪hfydhc")) {
    message.delete();
    message.channel
      .sendMessage("", {
        embed: {
...
client.on("message", message => {
  var args = message.content.split(/[ ]+/);
  if (message.content.includes("tsrsjcyfyf;624)﷼#|$?~~لعلنزنز")) {
    message.delete();
    message.channel
      .sendMessage("", {
        embed: {
...
client.on("message", message => {
  if (
    message.content === prefix + "الاعضاء" ||
    message.content === prefix + "الأعضاء"
  ) {
    let embed = new Discord.RichEmbed()
      .setAuthor(message.guild.name, message.guild.iconURL)
      .setTitle(`Members Status.:battery:`)
      .setDescription(
        `
الاعضاء المتصلين❤ :green_heart: : ${
...
الغير متصلين :black_heart: : ${
          message.guild.members.filter(m => m.presence.status == "offline").size
        }
الكل :blue_heart: :${message.guild.memberCount}
`
      )
      .setTimestamp()
...
client.on("message", message => {
  var prefix = "$";
  if (message.content === prefix + "اضهار") {
    if (!message.channel.guild) return;
    if (!message.member.hasPermission("ADMINISTRATOR"))
      return message.reply(":x:");
    message.channel.overwritePermissions(message.guild.id, {
...
client.on("guildMemberAdd", member => {
  member
    ...
    .then(function(channel) {
      const Embed11 = new Discord.RichEmbed().setColor("RANDOM")
        .setDescription(`🌹  ولكم نورت السيرفر ياوحش
👑اسم العضو  ${member}👑  
👤 انت العضو رقم ${member.guild.memberCount}👤 
رابط الدعم الفني https://discord.gg/Ncu645p 
...
**
        ***__General orders__***
**
『سيرفر /يعرض لك معلومات عن السيرفر$』
『معلوماتي/ يعرض لك معلومات عنك$』
[$سبورت / سيرفر المساعده』
『الأعضاء / لرؤية عدد الاعضاء بالسيرفر$ 』
『صوره / لرؤية صورة شخص$ 』
『بوت / لرؤية معلومات عن البوت$ 』
『تكيت / يفتح لك تكيت$ 』
『مغادره / لتحديد روم المغادرة$ 』
『الترحيب / لتحديد روم الترحيب$ 』
...
,`
        ***__SUPPORT__***
**
رابط الدعم الفني https://discord.gg/We9Gz4qqjf
**
